...
$ROUTESIM --timestamps-h ../testfiles/timestamps.json --sizes-h ../testfiles/sizes.json --in-dir $LAYOUT -u email --users $SAMPLES --days $DAYS -c $CONTACTS -d | sed 's/;/\n/g' > $OUTDIR/email_uoe_${SAMPLES}_${DAYS}_${EPOCH}_noguard
$ROUTESIM --timestamps-h ../testfiles/timestamps.json --sizes-h ../testfiles/sizes.json --in-dir $LAYOUT -u email --users $SAMPLES --days $DAYS -c $CONTACTS | sed 's/;/\n/g' > $OUTDIR/email_uoe_${SAMPLES}_${DAYS}_${EPOCH}_withguard

$ROUTESIM --timestamps-h ../testfiles/tariq/Work2_time_data.json --sizes-h ../testfiles/tariq/Work2_size_data.json --in-dir $LAYOUT -u email --users $SAMPLES --days $DAYS  -c $CONTACTS -d | sed 's/;/\n/g' > $OUTDIR/tariq_email_${SAMPLES}_${DAYS}_${EPOCH}_${LAYOUT_BASENAME}_noguard
$ROUTESIM --timestamps-h ../testfiles/tariq/Work2_time_data.json --sizes-h ../testfiles/tariq/Work2_size_data.json --in-dir $LAYOUT -u email --users $SAMPLES --days $DAYS -c $CONTACTS | sed 's/;/\n/g' > $OUTDIR/tariq_email_${SAMPLES}_${DAYS}_${EPOCH}_${LAYOUT_BASENAME}_withguard

$ROUTESIM --timestamps-h ../testfiles/frochet/frochet_timestamps.json --sizes-h ../testfiles/frochet/frochet_sizes.json --in-dir $LAYOUT -u email --users $SAMPLES --days $DAYS  -c $CONTACTS -d | sed 's/;/\n/g' > $OUTDIR/frochet_email_${SAMPLES}_${DAYS}_${EPOCH}_${LAYOUT_BASENAME}_noguard
$ROUTESIM --timestamps-h ../testfiles/frochet/frochet_timestamps.json --sizes-h ../testfiles/frochet/frochet_sizes.json --in-dir $LAYOUT -u email --users $SAMPLES --days $DAYS -c $CONTACTS | sed 's/;/\n/g' > $OUTDIR/frochet_email_${SAMPLES}_${DAYS}_${EPOCH}_${LAYOUT_BASENAME}_withguard
